    ...
    <section id="about" className="py-24 bg-white relative overflow-hidden border-b border-slate-200/50">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center md:text-left md:flex md:items-end md:justify-between mb-16 pb-6 border-b border-slate-200">
          <div>
            <span className="font-mono text-[10px] text-blue-600 uppercase tracking-widest block mb-2 font-bold">{t('about.tag')}</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-slate-650 leading-relaxed text-sm">
                {tText(
                  ...
                  "Over the past 25+ years of my career, I've been passionate about translating flat code into fluid, intuitive user experiences. Whether erecting react portals running high-volume metrics, coding bulletproof servers in Node.js/Express, or engineering custom AI model integrations, I pursue deep scalability and flawless execution."
                )}
              </p>
              <p className="text-slate-550 leading-relaxed text-sm">
                {tText(
                  ...
                  "I excel at serving as the technical core linking design visions and backend operations within agile teams. Fusing a high engineering aptitude with clear user empathy, I lead cross-disciplinary collaborations to generate lasting functional and commercial value."
                )}
              </p>
            </div>
            ...
            {PERSONAL_INFO.education && (
              <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                ...
                <div>
                  <span className="block text-[9px] font-mono text-slate-400 uppercase tracking-widest font-bold">{t('about.eduTag')}</span>
                  <span className="block text-sm font-extrabold text-slate-900 mt-0.5">
                    {tText(PERSONAL_INFO.education.degree, PERSONAL_INFO.education.englishDegree)}
                  </span>
                </div>
              </div>
            )}
          ...
          <div className="lg:col-span-12 xl:col-span-5 flex flex-col gap-6 lg:grid lg:grid-cols-3 xl:flex xl:flex-col">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-slate-50 border border-slate-200/80 rounded-xl p-6 flex items-center gap-4 lg:col-span-3 xl:col-span-1"
            >
